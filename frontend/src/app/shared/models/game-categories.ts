...
export const GAME_CATEGORIES: GameTag[] = [
  ...
  { name: 'Party Game', description: 'Designed for large groups, fast-paced and highly social' },
  { name: 'Abstract Strategy', description: 'No theme — pure strategy with perfect information (e.g. Chess, Go)' },
  { name: 'Economic', description: 'Core loop involves earning, spending, and managing money or resources' },
  { name: 'Dice', description: 'Dice are the primary component driving outcomes' },
...
{ name: 'Social Deduction', description: 'Players try to identify hidden roles or traitors among the group' },
  ...
  { name: 'Children\'s Game', description: 'Designed specifically for young children with very simple rules' },
  ...
  { name: 'Word Game', description: 'Players form or guess words to score points' },
